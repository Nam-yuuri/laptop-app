                            ...
                            <div className={cx('box-content')}>
                                ...
                                <div className={cx('content-related-promotion')}>
                                    ...
                                    <ul className={cx('promotion-list')}>
                                        ...
                                        <li>
                                            <span>
                                                Nhập mã PV100 giảm thêm 5% tối đa 100.000đ khi thanh toán qua VNPAY-QR.
                                            </span>
                                            <a href=" " className={cx('list-href')}>
                                                Xem chi tiết
                                            </a>
                                        ...
                                        <li>
                                            <span>
                                                Nhập mã PVAPPLE giảm thêm 4% tối đa 800.000đ cho đơn hàng Apple từ 20
                                                triệu khi thanh toán qua VNPAY-QR.
                                            </span>
                                            <a href=" " className={cx('list-href')}>
                                                Xem chi tiết
                                            </a>
